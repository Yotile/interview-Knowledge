...
- 占位图片生成的在线网站：[https://placeholder.com/](https://placeholder.com/)

　　好处是：素材做出来之前，先留出空位，方便以后换图。比如[http://via.placeholder.com/400x300](http://via.placeholder.com/400x300)这个链接可以生成400*300的占位图片。
