...
　　系统过滤器的使用，可以参考参考文档：[http://v1-cn.vuejs.org/api/#过滤器](http://v1-cn.vuejs.org/api/#%E8%BF%87%E6%BB%A4%E5%99%A8)

　　Vue也提供了一个接口用来供程序员定义属于自己的特殊逻辑，Vue称之为自定义过滤器。我们接下来讲一讲。

## 自定义全局过滤器

　　文档地址：[http://v1-cn.vuejs.org/guide/custom-filter.html](http://v1-cn.vuejs.org/guide/custom-filter.html)
